                ...
                <div class="col">
                    ...
                    <Form action="" method="POST" class="form">
                        <input type="hidden" name="ID" value="<?= $buku["ID"];  ?>" >
                            ...
                            <input type="text" class="form-content" name="judul" id="judul" required value="<?= $buku["judul"]; ?>">
                            
                            <label for="buat" style="padding-top: 10px;">Penyusun</label>
                            <input type="text" class="form-content" name="penyusun" id="buat" required value="<?= $buku["penyusun"]; ?>">
                            
                            <label for="terbit" style="padding-top: 10px;">Penerbit</label>
                            <input type="text" class="form-content" name="penerbit" id="terbit" required value="<?= $buku["penerbit"]; ?>">
                            
                            <label for="thn" style="padding-top: 10px;">Tahun Terbit</label>
                            <input type="text" class="form-content" name="tahun" id="thn" required value="<?= $buku["tahun"]; ?>">
                            
                            <button type="submit" name="submit" id="submit-btn" style="margin: 20px auto;">Update</button>
                    </Form>
                </div>
            </div>
        </div>
